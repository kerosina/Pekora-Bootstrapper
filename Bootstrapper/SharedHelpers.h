...
#define FIREFOXREGKEY               "@nsroblox.pekora.org/launcher"
#define FIREFOXREGKEY64             "@nsroblox.pekora.org/launcher64"
...
#define PLAYERLINKNAME_CUR          "Pekora2 Player"
#define PLAYERLINKNAMELEGACY        "Play Pekora2"

// MFC Studio names
#define STUDIOEXENAME               "ProjectXStudioBeta.exe"
#define STUDIOBOOTSTAPPERNAME       "ProjectXStudioBeta.exe"
#define STUDIOLINKNAMELEGACY        "Pekora2 Studio"    // wrong case
...
// Version URL string names (setup.pekora.org/XXX) - replace XXX with these values to get the most recent version
